...
\begingroup
    ...
    \captionof{figure}{Phase shift of the RL circuit at 1.4 kHz. Yellow line represents the $V_{aa}$ while purple line represents the $V_{bb}$ signal.}
