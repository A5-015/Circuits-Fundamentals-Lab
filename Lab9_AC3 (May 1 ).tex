...
\IEEEPARstart{T}\lowercase{he} goal of this lab was to simulate a  wye-connected, poly-phase circuit using LT Spice and observe the simulation values provided.\\
...
\begingroup
    ...
    \captionof{figure}{inst power through resistorse}
    \label{fig:circ3}
    \medskip
\endgroup
...
\begingroup
    ...
    \medskip
    %width=\columnwidth
    \includegraphics[width=\columnwidth]{images/Lab_9_ss_11.PNG}
    \captionof{figure}{ average power across voltage source 2}
    \label{fig:circ3}
    \medskip
\endgroup
...
\begingroup
    ...
    \captionof{figure}{ average power of resistor}
    \label{fig:circ3}
    \medskip
\endgroup
...
\begingroup
    ...
    \captionof{figure}{ average power of inductor}
    \label{fig:circ3}
    \medskip
\endgroup
